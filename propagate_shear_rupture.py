...
k2_prime = lambda a, Q, nu : k0_prime(a, Q) + 2*nu/(2-nu) * k1_prime(a, Q)
k3_prime = lambda a, Q, nu : k0_prime(a, Q) - 2*nu/(2-nu) * k1_prime(a, Q)
...
if '-noplot' not in sys.argv:
    ...
    # Save
    plt.savefig(args.save_path+'results/'+'{:s}.pdf'.format(simulation_name))
